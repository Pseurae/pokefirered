...
{   // { width, height, offset }
    ...
    [MOVE_CATEGORY_PHYSICAL + MENU_INFO_CATEGORY_START] = { 24, 12, 0x4 },
    [MOVE_CATEGORY_SPECIAL + MENU_INFO_CATEGORY_START]  = { 24, 12, 0x7 },
    [MOVE_CATEGORY_STATUS + MENU_INFO_CATEGORY_START]   = { 24, 12, 0xA }
};
